...
│   ├── api\_gateway\_v3.txt

│   ├── customer\_platform\_v2.txt

│   └── legacy\_reporting\_v1.txt

│

├── src/

│   ├── ai\_architecture\_review.py

│   ├── change\_alert.py

│   ├── change\_classifier.py

│   ├── dashboard.py

│   ├── metadata\_parser.py

│   └── standards\_validator.py
...
Rules → AI Assistance → Human Architecture Review
